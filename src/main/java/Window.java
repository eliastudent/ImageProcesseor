...
public class Window extends JFrame {
   ...
   RobotPlay robotPlay;
    public Window() {
        ...
        RobotPlay robotPlay = new RobotPlay();
        //TEXT
        ...
        //BUTTONS
        button("BlackAndWhite", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        button("EliminateRedOrGreenOrBlue", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2 * 2, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        button("Lighter", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2 * 3, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        button("Darker", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2 * 4, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        button("Mirror", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2 * 6, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        button("Contrast", WINDOW_HIGHET / 2 + DEFAULT_SPACE2 + DEFAULT_SPACE / 2, DEFAULT_COMPONENT_HIGHET + DEFAULT_SPACE2 * 5, WINDOW_WHIDTH / 4, DEFAULT_COMPONENT_HIGHET / 2);
        this.setVisible(true);

    }

    public void button(String str, int x, int y, int HIGHET, int WHIDTH) {
